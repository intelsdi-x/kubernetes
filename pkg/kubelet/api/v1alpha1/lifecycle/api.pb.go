...
const (
	...
	IsolationControl_CGROUP_HUGETLB_2MB_LIMIT IsolationControl_Kind = 3
	IsolationControl_CGROUP_HUGETLB_1GB_LIMIT IsolationControl_Kind = 4
)
...
var IsolationControl_Kind_name = map[int32]string{
	...
	2: "CONTAINER_ENV_VAR",
	3: "CGROUP_HUGETLB_2MB_LIMIT",
	4: "CGROUP_HUGETLB_1GB_LIMIT",
}
var IsolationControl_Kind_value = map[string]int32{
	"CGROUP_CPUSET_CPUS":       0,
	"CGROUP_CPUSET_MEMS":       1,
	"CONTAINER_ENV_VAR":        2,
	"CGROUP_HUGETLB_2MB_LIMIT": 3,
	"CGROUP_HUGETLB_1GB_LIMIT": 4,
}
...
var fileDescriptorApi = []byte{
	...
	,
}
