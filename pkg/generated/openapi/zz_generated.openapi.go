...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		...
		"k8s.io/kubernetes/pkg/api/v1.HugePagesVolumeSource": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "HugePagesSource represents Linux HugeTlbPage https://www.kernel.org/doc/Documentation/vm/hugetlbpage.txt",
					Properties: map[string]spec.Schema{
						"pageSize": {
							SchemaProps: spec.SchemaProps{
								Description: "Defaults to 2M",
								Type:        []string{"string"},
								Format:      "",
							},
						},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"hugePages": {
							SchemaProps: spec.SchemaProps{
								Description: "HugePages represensts a hugepage resource.",
								Ref:         ref("k8s.io/kubernetes/pkg/api/v1.HugePagesVolumeSource"),
							},
						},
					},
					Required: []string{"name"},
		...
		"k8s.io/kubernetes/pkg/apis/componentconfig/v1alpha1.KubeProxyConfiguration": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Required: []string{"featureGates", "bindAddress", "healthzBindAddress", "metricsBindAddress", "clusterCIDR", "hostnameOverride", "clientConnection", "iptables", "oomScoreAdj", "mode", "portRange", "resourceContainer", "udpTimeoutMilliseconds", "conntrack", "configSyncPeriod"},
				},
			},
			Dependencies: []string{
				...
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"dockerEnableSharedPID": {
							SchemaProps: spec.SchemaProps{
								Description: "This flag, if set, enables use of a shared PID namespace for pods run by the docker CRI runtime.",
								Type:        []string{"boolean"},
								Format:      "",
							},
						},
